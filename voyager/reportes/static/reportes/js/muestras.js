...
function validar_ingreso_muestra(){
    ...
    if (v1 == "vacío" && v2 == "vacío" && v3 == "vacío"){ //Si las tres funciones regresaron 0 significa que no se agregó ninguna muestra
...
function validar_producto_agricola(){// Validamos los arreglos de inputs
    ...
    $("input[name='productoAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#productoAG-'+id);
        flag = v;
    });
    $("input[name='variedadAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#variedadAG-'+id);
        flag = flag && v;
    });
    $("input[name='paisOrigenAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#pais-origenAG-'+id);
        flag = flag && v;
    });
    $("input[name='codigoMuestraAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#codigo-muestraAG-'+id);
        flag = flag && v;
    });
    $("input[name='proveedorAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#proveedorAG-'+id);
        flag = flag && v;
    });
    $("input[name='codigoTrazabilidadAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#codigo-trazabilidadAG-'+id);
        flag = flag && v;
    });
    $("input[name='agricultorAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#agricultorAG-'+id);
        flag = flag && v;
    });
    $("input[name='direccionAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#direccionAG-'+id);
        flag = flag && v;
    });
    $("input[name='parcelaAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#parcelaAG-'+id);
        flag = flag && v;
    });
    $("input[name='ubicacionMuestreoAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#ubicacion-muestreoAG-'+id);
        flag = flag && v;
    });
    $("input[name='urgenteAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#urgenteAG-'+id);
        flag = flag && v;
    });
    ...
    $("input[name='muestreadorAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#muestreadorAG-'+id);
        flag = flag && v;
    });
    $("input[name='paisDestinoAG[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#pais-destinoAG-'+id);
        flag = flag && v;
    });
    return flag;
}
function validar_producto_procesado(){// Validamos los arreglos de inputs
    ...
    $("input[name='tipoMuestraPR[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#tipo-muestraPR-'+id);
        flag = v;
    });
    $("input[name='descripcionMuestraPR[]']").each(function(){
        var id = $(this).data('id');
        v =check_is_not_empty($(this).val(),'#descripcion-muestraPR-'+id);
        flag = flag && v;
    });
    ...
    $("select[name='analisis1PR[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#primer-analisisPR-'+id);
        flag = flag && v;
    });
    return flag;
}
function validar_producto_microbiologia(){// Validamos los arreglos de inputs
    ...
    $("input[name='tipoMuestraMB[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#tipo-muestraMB-'+id);
        flag = v;
    });
    $("input[name='loteCodigoMB[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#lote-codigoMB-'+id);
        flag = flag && v;
    });
    ...
    $("input[name='muestreadorMB[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#muestreadorMB-'+id);
        flag = flag && v;
    });
    $("select[name='analisis1MB[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#primer-analisisMB-'+id);
        flag = flag && v;
    });
    $("input[name='metodoReferenciaMB[]']").each(function(){
        var id = $(this).data('id');
        v = check_is_not_empty($(this).val(),'#metodo-referenciaMB-'+id);
        flag = flag && v;
    });
    return flag;
}
