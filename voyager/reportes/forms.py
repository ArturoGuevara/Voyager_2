...
class EditarFactura(forms.Form):
        ...
        numero_fact = forms.CharField(max_length=10000)
        complemento_pago = forms.CharField(max_length=10000)
        pago_fact = forms.CharField(max_length=10000)
        orden_compra = forms.CharField(max_length=10000)
        fecha_fact = forms.CharField(max_length=10000)
        fecha_envio_factura = forms.CharField(max_length=10000)
        envio_fact = forms.CharField(max_length=10000)
        cobro_envio = forms.CharField(max_length=10000)
        envio_informes = forms.CharField(max_length=10000)
        cantidad_pagada = forms.DecimalField(max_digits=10,decimal_places=2)
        oi_id_fact = forms.CharField(max_length=10000)
