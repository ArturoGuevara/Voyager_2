    ...
    if(flag == 0){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('#editar-cot-tabla-analisis-resumen').append('<tr class="edit-cot-res-an" data-id="' + id +'"><td>' + data.fields.codigo + '</td><td>' + data.fields.nombre + '</td><td><input id="edit-cot-pr-' + id + '" name="edit-cot-precios[]" value='+ data.fields.precio +' hidden>$' + data.fields.precio + '</td><td><input type="number" class="form-control" id="edit-cot-an-' + id + '" data-id="' + id + '" name="editar-cot-cantidades[]" onchange="calc_total()" min=1 value=1 style="width: 75px;"><div class="invalid-feedback">Por favor introduce una cantidad</div></td><td><input type="number" class="form-control" id="edit-cot-de-' + id + '" data-id="' + id + '" name="edit-cot-descuentos[]" min=0 value=0 onchange="calc_total()" style="width: 100px;"></td><td><input type="number" class="form-control" id="edit-cot-iva-' + id + '" data-id="' + id + '" name="edit-cot-ivas[]" min=0 value=16 onchange="calc_total()" style="width: 60px;"></td><td><input type="number" class="form-control" id="edit-cot-to-' + id + '" data-id="' + id + '" name="edit-cot-totales[]" value='+ total_analisis +' style="width: 100px;" readonly></td><td><button type="button" class="btn btn-danger" onclick="editar_cot_eliminar_an(' + id + ')"><i class="fa fa-trash"></i></button></td></tr>');
                calc_total();
            },
        });
    }else{
